...
RULE_LABELS = {
    ...
    "price": "ціна одночасних оголошень різниться понад поріг",
...
# 20% — за калібруванням 23.09: на парах з однаковим id квартири DIM.RIA
# поріг 10% помилявся б на 6,8% пар, 20% — на 2,2% (користь 10,7% проти 17,3%).
PRICE_CONCURRENT = float(os.environ.get("DEDUP_PRICE_GAP", 0.20))
